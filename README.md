<p align="center">
  <img src="media/app-icon.png" width="112" alt="Taskbar App Groups">
</p>

<h1 align="center">Taskbar App Groups</h1>

<p align="center">
  Fold a crowded Windows 11 taskbar into a few group icons.<br> Click one, and the apps inside fan out with live previews of their windows.
</p>
...
<p align="center">
  <img src="media/hero.gif" width="820" alt="Clicking a group on the taskbar opens its flyout, and hovering an app shows a live preview of its window">
</p>

<p align="center">
  <sub>One click on a group icon. Recorded on a real Windows 11 taskbar.</sub>
</p>
...
<p align="center">
  <img src="media/drag.gif" width="900" alt="Three apps picked with Ctrl, dragged across as one stack, dropped into a group, then undone with one Ctrl+Z">
</p>
...
<table>
<tr>
<td align="center"><img src="media/icons/TV-256.png" width="72" alt="Text only"></td>
<td align="center"><img src="media/icons/BROWSERS-256.png" width="72" alt="App grid"></td>
<td align="center"><img src="media/icons/Random-256.png" width="72" alt="Grid plus text"></td>
<td align="center"><img src="media/icons/OneApp-256.png" width="72" alt="One app"></td>
<td align="center"><img src="media/icons/More%20Random%20Stuff-256.png" width="72" alt="Your image"></td>
<td align="center"><img src="media/icons/Tools-256.png" width="72" alt="Drawn in the designer"></td>
<td align="center"><img src="media/icons/Design-256.png" width="72" alt="Drawn in the designer"></td>
<td align="center"><img src="media/icons/Coding-256.png" width="72" alt="Drawn in the designer"></td>
</tr>
<tr>
<td align="center"><sub><b>Text only</b></sub></td>
<td align="center"><sub><b>App grid</b></sub></td>
<td align="center"><sub><b>Grid plus text</b></sub></td>
<td align="center"><sub><b>One app</b></sub></td>
<td align="center"><sub><b>Your image</b></sub></td>
<td align="center"><sub><b>Your own design</b></sub></td>
<td align="center"><sub><b>Your own design</b></sub></td>
<td align="center"><sub><b>Your own design</b></sub></td>
</tr>
</table>

<sub>Real group icons off one taskbar, composed by the app at the size Windows asks for. Nothing here was drawn for the screenshot.</sub>
...
<p align="center">
  <img src="media/flyout-edit.gif" width="820" alt="A one row flyout being edited in place: the edge is dragged and the apps reflow into three rows, then the names are turned off and the flyout tightens to icons only">
</p>

<p align="center">
  <sub>The same group, reshaped by dragging its edge. Nothing opens, nothing is saved, and Esc puts it back.</sub>
</p>
...
<td width="48%"><img src="media/flyout-shapes.png" width="100%" alt="One group drawn four ways: one row with names, three rows with names, three rows with no names, and the same with the group's name hidden"></td>
</tr>
</table>
...
<p align="center">
  <img src="media/mixed-group.png" width="820" alt="A flyout holding apps, a folder and a document side by side, each with its real Windows icon">
</p>

<table>
<tr>
<td width="48%"><img src="media/browser.png" width="100%" alt="The Folders and files tab: quick access down the left, a breadcrumb, a search box, sortable headings and a list of files with their real thumbnails"></td>
<td width="52%" valign="top">
...
<td width="48%"><img src="media/drop-from-explorer.gif" width="100%" alt="Two files dragged out of a real Explorer window and dropped onto a group's card, where they appear as tiles"></td>
</tr>
</table>
...
<td width="54%"><img src="media/flyout-with-previews.png" width="100%" alt="Previews appearing as apps are hovered"></td>
</tr>

<tr>
<td width="46%"><img src="media/peek.gif" width="100%" alt="Hovering a preview brings the real window forward at full size"></td>
...
<td width="54%"><img src="media/editor-designer.png" width="100%" alt="The icon designer"></td>
</tr>
...
<td width="54%"><img src="media/editor-app-icons.png" width="100%" alt="The app icon page"></td>
</tr>

<tr>
<td width="46%"><img src="media/editor-settings.png" width="100%" alt="Settings"></td>
<td width="54%" valign="top">
...
<p align="center">
  <img src="media/new-group.gif" width="900" alt="Four apps picked in the installed list, dragged across as one stack and dropped on Drop apps here to make a group, which makes the group and names it">
</p>
...
<p align="center">
  <img src="media/editor-group-tools.png" width="900" alt="A group's own page: the apps in it as chips, the six icon styles with one chosen, the tile colour, and the icon at its real size on a taskbar">
</p>
...
<p align="center">
  <img src="media/pin-it.gif" width="620" alt="The group's icon dragged out of the app and dropped onto the taskbar, where it becomes a pinned button">
</p>
...
<details>
<summary>The detail, including what it does cost</summary>
...
<details>
<summary>A pinned button keeps the picture it was pinned with</summary>
...
<details>
<summary>Pinning and unpinning is yours to do</summary>
...
<details>
<summary>It is not a taskbar replacement</summary>
...
<details>
<summary>What it does with your data, which is nothing</summary>
...
<details>
<summary>Uninstalling takes its things with it</summary>
...
<p align="center">
  <sub>Built for Windows 11. Report a problem on the <a href="../../issues">issues page</a>, or read
  what changed in the <a href="../../releases">release notes</a>.</sub>
</p>
