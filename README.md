...
<table>
<tr>
<td align="center"><img src="media/icons/AI-256.png" width="72" alt="Text only"></td>
<td align="center"><img src="media/icons/BROWSERS-256.png" width="72" alt="App grid"></td>
<td align="center"><img src="media/icons/Randum%20Stuff-256.png" width="72" alt="Grid plus text"></td>
...
<sub>Seven real groups off one taskbar. Nothing here was drawn for the screenshot.</sub>
...
<tr>
<td width="46%"><img src="media/drag.gif" width="100%" alt="Three apps picked with Ctrl, dragged across as one stack, dropped into a group, then undone with one Ctrl+Z"></td>
<td width="54%" valign="top">
...
<p align="center">
  <img src="media/new-group.gif" width="100%" alt="Four apps picked in the installed list, dragged across as one stack and dropped on Drop apps here to make a group, which makes the group and names it">
</p>

**2. Give it a face.** Pick a template, drop in a picture, or open the designer and draw one.

<p align="center">
  <img src="media/editor-group-tools.png" width="100%" alt="A group's own page: the apps in it as chips, the six icon styles with one chosen, the tile colour, and the icon at its real size on a taskbar">
</p>
...
<p align="center">
  <img src="media/pin-it.gif" width="100%" alt="The shortcuts folder open, the group's shortcut dragged out of it and dropped onto the taskbar, where it becomes a pinned button">
</p>
